...
export const SettingsMenu = ({ state, admin }: { state: State, admin: boolean }): VNode => (
    <div class={"settings"}>
        <div>
            <h2
            ...
            <form onsubmit={function (state: State, event: SubmitEvent): Dispatchable {
                            ...
                            <td>
                                <input
                                    ...
                                    oninput={(state: State): State => ({
                                        ...state,
                                        room: { ...state.room, public: !state.room.public }
                                    })}
                                    disabled={!admin}
                                />
                            </td>
